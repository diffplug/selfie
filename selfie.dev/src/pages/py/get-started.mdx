...
To start snapshot testing in Python, all you need is to add a [single dependency](https://central.sonatype.com/artifact/com.diffplug.selfie/selfie-runner-junit5).
...
{/* To be changed with knew python dependencies */}
