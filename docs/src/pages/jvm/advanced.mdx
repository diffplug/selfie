...
Inline snapshots are a partial fix for storytelling within a test, but the harnessing can become verbose. This is where we combine all of selfie's features:

- exhaustively detailed specification on disk
- succinct storytelling inline
- very little boilerplate thanks to `Camera` and `CompoundLens`
