...
Adding support for other languages is [straightforward](https://github.com/diffplug/selfie/blob/main/kotlin/selfie-lib/src/commonMain/kotlin/com/diffplug/selfie/guts/Literals.kt), PRs are welcome!
...
Replace `LATEST_VERSION` with the [latest available version of selfie](https://github.com/diffplug/selfie/blob/main/kotlin/CHANGELOG.md).
...
Again, replace `LATEST_VERSION` with the [latest available version of selfie](https://github.com/diffplug/selfie/blob/main/kotlin/CHANGELOG.md).
